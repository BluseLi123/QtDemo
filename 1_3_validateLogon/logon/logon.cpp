    ...
    ui(new Ui::Logon)
{
    ...
    this->setFixedSize(405, 435);
    this->setStyleSheet("background-color:white;border: 1px solid #C6C6C6");
    loginMode=0;
    loginType=0;
    ...
    closeBtn->setStyleSheet("background-image: url(:/source/login/close.png); border:0px");
    connect(closeBtn, SIGNAL(clicked()), SLOT(close()));

    signtypeLab = new QLabel(this);
    signtypeLab->setGeometry(200, 45, 135, 30);
    signtypeLab->setStyleSheet("background-image: url(:/source/login/signtype1.png); border:0px");
    signiconTbtn = new QToolButton(this);
    signiconTbtn->setGeometry(340, 45, 60, 60);
    signiconTbtn->setStyleSheet("background-image: url(:/source/login/signicon1.png); border:0px");
    ...
    userName->setPlaceholderText(tr("电话/学号/姓名"));
    ...
    signweiboBtn->setStyleSheet("background-image: url(:/source/login/weibo.png); border:0px");
    QPushButton* signrenrenBtn=new QPushButton(widgetTrad);
    signrenrenBtn->setGeometry(150, 295, 25, 25);
    signrenrenBtn->setStyleSheet("background-image: url(:/source/login/renren.png); border:0px");

    QWidget *widgetScan= new QWidget();
    QLabel *infoLab=new QLabel(widgetScan);
    infoLab->setText(tr("手机扫码，安全登录校园通"));
    ...
    qrLab->setStyleSheet("background-image: url(:/source/login/QRcode.png);");
    qrLab->setGeometry(70, 60, 145, 145);
    QLabel *advLab=new QLabel(widgetScan);
    advLab->setText(tr("校园生活，扫我开始"));
    ...
    signqqTbtn->setIcon(QIcon(":/source/login/qq.png"));
    ...
    signweixinTbtn->setIcon(QIcon(":/source/login/weixin.png"));
...
void Logon::setloginMode()
{
    ...
    else
    {
        ...
        signtypeLab->setStyleSheet("background-image: url(:/source/login/signtype2.png); border:0px");
        signiconTbtn->setStyleSheet("background-image: url(:/source/login/signicon2.png); border:0px");
